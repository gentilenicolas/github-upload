...
class RealizarOpModel {
    ...
    String comentarios;
    SucursalesModel suc;
    EntregoPagoModel reciboPago;
    EntregoPagoModel entregoPago;
    CuentaBancariaModel cuentaBancaria;
    String comprobanteDepo;
    String nroDepo;

    factory RealizarOpModel.fromJson(Map<String, dynamic> json) => RealizarOpModel(
        opSimulada: SimularOpModel.fromJson(json["opSimulada"]),
        fecha: DateTime.parse(json["Fecha"]),
        comentarios: json["comentarios"],
        suc: SucursalesModel.fromJson(json["suc"]),
        reciboPago: EntregoPagoModel.fromJson(json["ReciboPago"]),
        entregoPago: EntregoPagoModel.fromJson(json["EntregoPago"]),
        cuentaBancaria: CuentaBancariaModel.fromJson(json["cuentaBancaria"]),
