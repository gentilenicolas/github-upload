...
class RegistroCliente extends StatelessWidget {
      ...
      child: Column(
        children: <Widget>[
          ...
          Container(
            ...
            child: Column(
              children: <Widget>[
                Text('Crear cuenta usuario', style: TextStyle(fontSize: 20.0)),
 ...
 Widget _crearNombre(LoginBloc bloc) {
  ...
  _login(LoginBloc bloc, BuildContext context) {
    print('================');
    print('Nombre: ${bloc.nombre}'); // cambiar estas propiedades por las que sno 
    print('Apellido: ${bloc.nombre}');
